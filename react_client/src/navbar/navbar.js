    ...
    return (
      <nav>
        ...
        <div className="actions">
          <label className="nav-item" htmlFor="btn-save" title="Save">
          ...
          <label onClick={this.parentMethods.callOpenFile} className="nav-item" htmlFor="btn-open-file" title="Open file">
            <svg fill="#fff" height="18" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 0h24v24H0z" fill="none" />
